(function (global, factory) {
  ...
  function injectarquivos(url, waitFor, callback) {
    if (isNil(url)) {
      console.error('Inject arquivos error');
      return;
    }
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectarquivos(this.settings.plyr.css, 'Plyr');
    var url = data.href;
    ...
    injectarquivos(this.settings.plyr.js, 'Plyr', function () {
    ...
    _createClass(GlightboxInit, [{
      ...
      value: function open() {
        ...
        if (isNode(element)) {
          ...
          if (foto) {
            ...
            this.elements = this.getGalleryElements(this.elements, foto);
          }
      ...
      value: function getElements() {
        ...
        each(nodes, function (el, i) {
          ...
          slideInfo.instance = slide;
          slideInfo.slideConfig = elData;
          slideInfo.foto = el.getAttribute('data-foto');
          list.push(slideInfo);
        });
      ...
      value: function getGalleryElements(list, foto) {
